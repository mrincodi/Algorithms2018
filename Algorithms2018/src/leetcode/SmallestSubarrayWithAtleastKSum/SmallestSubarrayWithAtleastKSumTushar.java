 ...
 */
public class SmallestSubarrayWithAtleastKSumTushar {
	...
	public  static void main(String[] args) {
		...
		SmallestSubarrayWithAtleastKSumTushar ss = new SmallestSubarrayWithAtleastKSumTushar();
		int r = ss.shortestSubarray(input, 8);
